...
const App = () => {
  ...
  useEffect(() => {
    personService.getAll(handleMessage).then((response) => {
      setPersons(response);
    });
  }, []);
  ...
  const handlesubmit = (event) => {
    ...
    if (person === undefined) {
      ...
      personService.create(newPerson, handleMessage).then((person) => {
      ...
      if (
        ...
        const updatePerson = {...person,name:newName, number:newPhone};
        personService.update(updatePerson, handleMessage, () => {
          //update UI
